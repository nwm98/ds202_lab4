...
Answer:
  ```{r}
ggplot(aes(x=Opponent_Opponent, y=scale), data=offpvt) + geom_point()+theme(axis.text.x=element_text(angle=90, hjust=1))+facet_grid(Name~stat)
```
...
ggplot(aes(x=stat, y=avg_mean, color=Opponent_Opponent), data=isudefstat)+geom_point()+theme(axis.text.x=element_text(angle=90, hjust=1))
ggplot(aes(x=stat, y=avg_mean, color=Opponent_Opponent), data=isudefstattotal2)+geom_point()+theme(axis.text.x=element_text(angle=90, hjust=1))
```
...
ggplot(aes(x=stat, y=avg_mean, color=Opponent_Opponent), data=isuoffstat)+geom_point()+theme(axis.text.x=element_text(angle=90, hjust=1))
ggplot(aes(x=stat, y=avg_mean, color=Opponent_Opponent), data=isuoffstattotal2)+geom_point()+theme(axis.text.x=element_text(angle=90, hjust=1))  
```
...
ggplot(aes(x=stat,y=(avg_mean - avg_mean19)), data=defjoin)+geom_point()+facet_wrap(~Name)+theme(axis.text.x=element_text(angle=90, hjust=1))
```
...
```{r}
ggplot(aes(x=stat,y=(avg_mean - avg_mean19)), data=offjoin)+geom_point()+facet_wrap(~Name)+theme(axis.text.x=element_text(angle=90, hjust=1))
```
